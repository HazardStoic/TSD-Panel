...
<div class="container-fluid p-3">
    <ul class="nav nav-tabs">
        <li class="p-b m-r">
            <button class="btn btn-default" type="button" data-toggle="modal" data-target="#modalDiv" data-action="new_user">Add user</button>
        </li>
        <li class="p-b m-r">
            <button class="btn btn-default" type="button" data-toggle="modal" data-target="#modalDiv" data-action="export_user">Backup users</button>
        </li>
        <li class="p-b m-r">
            <button class="btn btn-default" type="button" data-toggle="modal" data-target="#modalDiv" data-action="alert_user">Send Notification</button>
        </li>
        <li class="p-b m-r">
            <button class="btn btn-default" type="button" data-toggle="modal" data-target="#modalDiv" data-action="all_numbers">Contact Information</button>
        </li>
        <li class="p-b m-r">
            <button class="btn btn-default" type="button" data-toggle="modal" data-target="#modalDiv" data-action="details">Details</button>
        </li>
        <li class="p-b m-r">
            <a href="<?php echo site_url('admin/clients/delete_zero_fund_users'); ?>" id="delete-users-button" class="btn btn-default">Delete Inactive Users</a>
        </li>
    </ul>
                        ...
                        <td>
                            ...
                            <?php if ($client["verified"] == "Yes") : ?>
                                <div class="tooltip5">
                                    ...
                                    <span class="tooltiptext5">Email Is Verified</span>
                                </div>
                            <?php endif; ?>
                        </td>
                        <td>
                        ...
                        for ($page = 1; $page <= $pageCount; $page++) :
                            if ($page >= ($paginationArr['current'] - 9) and $page <= ($paginationArr['current'] + 9)) : ?>
                                <li class="<?php if ($page == $paginationArr["current"]) : echo "active";
                                            endif; ?>"><a href="<?php echo site_url("admin/clients/" . $page . $search_link) ?>"><?php echo $page ?></a></li>
                        <?php endif;
                        endfor;
...
<script>
    // SweetAlert confirmation for Delete Inactive Users
    document.getElementById('delete-users-button').addEventListener('click', function(event) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '<?php echo site_url('admin/clients/delete_zero_fund_users'); ?>';
            }
        });
    });
</script>
