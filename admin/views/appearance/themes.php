...
<ul class="list-group">
    <li class="list-group-item"
        style="background-color: <?php echo $settings['summary_card_background_color'] == 'theme_colour' ? '#28a745' : 'transparent'; ?>;">
        <a class="nav-link"
           href="<?php echo site_url('admin/appearance/themes/eternity-settings/theme_colour'); ?>"
           style="color: <?php echo $settings['summary_card_background_color'] == 'theme_colour' ? '#fff' : '#ff4500'; ?>;">
           Theme colour
        </a>
    </li>
    <li class="list-group-item"
        style="background-color: <?php echo $settings['summary_card_background_color'] == 'fixed_colour' ? '#28a745' : 'transparent'; ?>;">
        <a class="nav-link"
           href="<?php echo site_url('admin/appearance/themes/eternity-settings/fixed_colour'); ?>"
           style="color: <?php echo $settings['summary_card_background_color'] == 'fixed_colour' ? '#fff' : '#ff4500'; ?>;">
           Fixed colour
        </a>
    </li>
</ul>
