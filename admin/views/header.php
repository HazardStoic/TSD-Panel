...
<li class="<?php if (route(1) == 'clients') : echo 'active'; endif; ?>">
    <a class="ajax-link" href="<?php echo site_url('admin/clients') ?>">
        <i class="fas fa-users"></i> <span><b>Users</b></span>
    </a>
</li>
...
<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
   ...
   <i class="fas fa-cogs"></i> <b>Services</b> <span class="caret"></span>
</a>
...
<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
    <i class="fa fa-shopping-cart"></i> <b>Orders</b><span class="caret"></span>
</a>
...
<li class="<?php if (route(1) == 'orders') : echo 'active'; endif; ?>">
    <a class="ajax-link" href="<?php echo site_url('admin/orders') ?>">
        <i class="fas fa-box"></i> <span><b>Orders</b></span>
    </a>
</li>
...
<li class="<?php if (route(1) == 'tasks') : echo 'active'; endif; ?>">
    <a class="ajax-link" href="<?php echo site_url('admin/tasks') ?>">
        <i class="fas fa-tasks"></i> <span> <b>Tasks</b></span>
    </a>
</li>
...
<li class="<?php if (route(1) == 'dripfeed') : echo 'active'; endif; ?>">
    <a class="ajax-link" href="<?php echo site_url('admin/dripfeed') ?>">
        <i class="fas fa-sync-alt"></i><span><b>Drip-feeds</b></span>
    </a>
</li>
...
<li class="<?php if (route(1) == 'subscriptions') : echo 'active'; endif; ?>">
    <a class="ajax-link" href="<?php echo site_url('admin/subscriptions') ?>">
        <i class="fas fa-calendar-alt"></i><span> <b>Subscriptions</b></span>
    </a>
</li>
...
<li class="<?php if (route(1) == 'payments') : echo 'active'; endif; ?>">
    <a class="ajax-link" href="<?php echo site_url('admin/fund-add-history') ?>">
        <i class="fas fa-credit-card"></i><span> <b>Payments</b></span>
    </a>
</li>
...
<li class="<?php if (route(1) == 'tickets') : echo 'active'; endif; ?>">
    <a class="ajax-link" href="<?php echo site_url('admin/tickets') ?>">
        <i class="fas fa-ticket-alt"></i><span> <b>Tickets</b>
...
<li class="<?php if (route(1) == 'appearance') : echo 'active'; endif; ?>">
    <a class="ajax-link" href="<?php echo site_url('admin/appearance') ?>">
        <i class="fas fa-paint-brush"></i> <span><b>Appearance</b></span>
    </a>
</li>

<li class="<?php if (route(1) == 'settings') : echo 'active'; endif; ?>">
    <a class="ajax-link" href="<?php echo site_url('admin/settings') ?>">
        <i class="fas fa-cogs"></i> <span><b>Settings</b></span>
    </a>
</li>

<li class="<?php if (route(1) == 'account') : echo 'active'; endif; ?>">
    <a class="ajax-link" href="<?php echo site_url('admin/account') ?>">
        <i class="fas fa-user"></i> <span><b>Account</b></span>
    </a>
</li>
 ...
 <!-- <li>
    <a href="/user_display.php">
        <i class="fas fa-redo"></i> <b>Renewal</b>
    </a>
</li> -->
...
<li>
    <a href="#" onclick="showScriptSupport(); return false;">
        <i class="fa fa-question-circle"></i> <b>Script support</b>
    </a>
</li>
...
<li>
    <a class="ajax-link" href="admin/logout">
...
<?php endif; ?>
    ...
    .swal2-title {
        font-size: 24px !important; /* Increase the title size */
    }

    .swal2-content {
        font-size: 20px !important; /* Increase the content size */
    }

    .swal2-actions .swal2-styled {
        font-size: 18px !important; /* Increase the button size */
       ...
       <script>
          function showScriptSupport() {
    Swal.fire({
        title: 'SCRIPT DETAILS',
        html: `
            <div style="font-family: Arial, sans-serif; text-align: center;">
                <h4 style="color: #007bff;">Tajammal Hussain</h4>
                <p style="font-size: 16px; color: #333;">For support, contact us:</p>
                <p><b>Email:</b> tajammalmods@gmail.com</p>
               
             <button onclick="window.location.href='https://whatsapp.com/channel/0029VaVFGy5ISTkS0xRQNW0l';"> Contact On Whatsapp</button>
        ...
        width: '600px',  // Increase the size of the popup
