...
elseif ($action == "pay_rent"):
  if (!$_POST["state"]) {
    ...
    if (!$_SESSION["upi"]) {
      $upi = "upi://pay?pa=ownsmmpanel@ybl&pn=OwnSMMPanel&am=$amount&mam=$amount&tn=Monthly%20Rent%20Payment&tr=$txn_id";
      $_SESSION["upi"] = $upi;
    }
...
';
    ...
    if ($resp["STATUS"] == "TXN_SUCCESS") {
      ...
      $to = "mail.socialkart@gmail.com";
      $to1 = "ownsmmpanel@gmail.com";
      $fromName = $_SERVER["HTTP_HOST"];
      $from = "email@socialmediamart.in";

      $subject = "Rent Payment : " . $_SERVER["HTTP_HOST"] . "";
      $mail->IsSMTP();
      $mail->CharSet = 'UTF-8';
      $mail->Host = "mail.socialmediamart.in";
      $mail->SMTPDebug = 0;
      $mail->SMTPAuth = true;
      $mail->Port = 587;
      $mail->Username = $from;
